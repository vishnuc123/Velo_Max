    ...
    try {
      ...
      coupons.forEach((coupon) => {
        ...
        row.innerHTML = `
                  ...
                  <td class="py-4 px-6">
                  <button class="bg-gray-400 text-blue-600 hover:text-blue-800 transition-transform duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-full px-4 py-2 hover:scale-105 active:scale-95">
                  Edit
                  </button>
